...
_MachopDexEntry::
	text "'latreúei na xtízei"
	next "toyº múeº toy."
	next "Ekpaideúetai"

	page "se óleº tiº pole-"
...
_TentacruelDexEntry::
	...
	next "na piásei cária"
	dex

_GoldeenDexEntry::
	text "To pterúgio thº"
	next "oyráº thº kyma-"
